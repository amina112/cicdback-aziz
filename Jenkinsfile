pipeline{
  ...
  sh 'mvn clean package deploy:deploy-file -DgroupId=com.esprit.examen -DartifactId=tpAchatProject -Dversion=1.3 -DgeneratePom=true -Dpackaging=jar -DrepositoryId=deploymentRepo -Durl=http://localhost:8081/repository/maven-releases/ -Dfile=target/tpAchatProject-1.2.jar'
...
stage('Build Docker Image') {
				...
				sh 'docker login -u amina112 --password dckr_pat_XhRLl3NFeq1alvvyyQmbnbbB--o'
                                            }
		  }
